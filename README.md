...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://stock-analyser-demo-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://stock-analyser-demo-__________run.app
```

Call the api endpoint:
```
curl https://stock-analyser-demo-__________run.app/stockAnalyserDemo
```
